...
// DOM elements
const burgercat = document.querySelector("#roingus");
const timeElm = document.querySelector("#time");
const countElm = document.querySelector("#count");

// Audio elements
const grabAudio = new Audio("/assets/audio/release.mp3");
...
function setCount() {
  ...
  countElm.innerHTML = `you have clicked burgercat ${roingusCount} times `;
}
...
function setTime() {
  ...
  let roingus = roingName();
  timeElm.innerHTML = `you have observed burgercat for <br> ${convertSeconds(
    time
  )}`;
